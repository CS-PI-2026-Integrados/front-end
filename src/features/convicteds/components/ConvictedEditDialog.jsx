...
export function ApenadoEditDialog({ apenado, onSave, onOpenChange }) {
  const {
    ...
    actions,
  } = useConvictedForm(apenado, apenado?.tenantId)
  ...
  return (
    <Dialog
      open={Boolean(apenado)}
      onOpenChange={(aberto) => {
        if (!aberto) onOpenChange(false)
      }}
    >
      <DialogContent
      ...
      >
        <DialogHeader className="flex-row items-start justify-between gap-4 px-6 py-4 text-left">
          <div>
            <DialogTitle className="text-lg font-bold">Editar Apenado</DialogTitle>
            <DialogDescription className="mt-1">
              Atualize os dados do apenado no formulário abaixo
            </DialogDescription>
          </div>
          <DialogClose asChild>
            <Button
          ...
          <div className="mb-5">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div className="flex flex-col items-start gap-2 pt-1">
                ...
                <span className="text-muted-foreground text-xs">JPG ou PNG, até 5MB.</span>
                {errors.foto && (
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                />
                {errors.nomeCompleto && (
                  <p className="text-destructive mt-0.5 text-xs">{errors.nomeCompleto}</p>
                )}
              </div>
              <div>
                <Label
                  htmlFor="modal-edit-cpf"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
              ...
              <div>
                <Label
                  htmlFor="modal-edit-nascimento"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Data de Nascimento <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="modal-edit-nascimento"
                  type="date"
                  name="dataNascimento"
          ...
          <div className="border-border mb-5 rounded-lg border p-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                <Label
                  htmlFor="modal-edit-logradouro"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Logradouro <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="modal-edit-logradouro"
                  name="logradouro"
              ...
              <div className="sm:col-span-2">
                <Label
                  htmlFor="modal-edit-numero"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Número <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="modal-edit-numero"
                  name="numero"
                  value={form.numero}
                  onChange={handleChange}
                  placeholder="123"
              ...
              <div className="sm:col-span-3">
                <Label
                  htmlFor="modal-edit-complemento"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Complemento
                </Label>
                <Input
                  id="modal-edit-complemento"
                  name="complemento"
              ...
              <div className="sm:col-span-3">
                <Label
                  htmlFor="modal-edit-bairro"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Bairro <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="modal-edit-bairro"
                  name="bairro"
                  value={form.bairro}
                  onChange={handleChange}
                  placeholder="Bairro"
              ...
              <div className="sm:col-span-4">
                <Label
                  htmlFor="modal-edit-cidade"
                  className="text-muted-foreground mb-1 text-xs font-semibold"
                >
                  Cidade <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="modal-edit-cidade"
                  name="cidade"
                  value={form.cidade}
                  onChange={handleChange}
                  placeholder="Cidade"
              ...
              <div className="border-border/60 bg-muted/40 flex flex-wrap items-center gap-x-4 gap-y-1 rounded-md border px-3 py-2.5 text-xs">
                <div>
                  ...
                  <span className="text-foreground font-semibold">
                    {procSelecionado.institution || procSelecionado.instituicao || 'Não informada'}
                  </span>
                </div>
                ...
                {(procSelecionado.penaltyType || procSelecionado.tipoPena) && (
                  <div>
