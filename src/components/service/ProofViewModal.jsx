        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <div className="w-full space-y-2 text-sm">
            <div className="flex justify-between border-b pb-2">
              ...
              <span className="text-right font-medium">{comprovante.apenadoName}</span>
            </div>
            <div className="flex justify-between border-b pb-2">
            ...
            <div className="flex justify-between border-b pb-2">
              ...
              <span className="font-medium">
                {new Date(comprovante.dateTime).toLocaleString('pt-BR')}
              </span>
            </div>
            <div className="flex justify-between border-b pb-2">
              <span className="text-muted-foreground">Operador</span>
              <span className="text-right font-medium">{comprovante.operatorName}</span>
            </div>
            <div className="flex justify-between pb-2">
              <span className="text-muted-foreground">Cód. Validação</span>
              <span className="text-right font-mono text-xs font-medium">
                {comprovante.verificationCode}
              </span>
            </div>
          </div>
        </div>
